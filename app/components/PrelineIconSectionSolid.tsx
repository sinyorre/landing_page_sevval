        ...
        <>
            ...
            <div className="mx-auto max-w-[85rem] px-4 py-10 sm:px-6 lg:px-8 lg:py-14">
                <div className="grid items-center gap-2 sm:grid-cols-2 lg:grid-cols-4">
                    {/* Icon Block */}
                    <a
                        className="group flex flex-col justify-center rounded-xl p-4 hover:bg-gray-50 focus:bg-gray-50 focus:outline-none dark:hover:bg-neutral-800 dark:focus:bg-neutral-800 md:p-7"
                        href="#"
                    >
                        ...
                        <div className="mt-5">
                            ...
                            <span
                                className="mt-2 inline-flex items-center gap-x-1.5 text-sm font-medium text-blue-600 decoration-2 group-hover:underline group-focus:underline">
                                Learn more
                                <svg
