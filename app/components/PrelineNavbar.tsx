    ...
    return (
        <header
            ...
            <nav className="container mx-auto sm:flex sm:items-center sm:justify-between">
                ...
                >
                    <div
                        className="flex flex-col gap-5 mt-5 sm:flex-row sm:items-center sm:justify-end sm:mt-0 sm:ps-5 p-2">
                        <Link href="/"
                              className={`${playfairDisplay.className} font-medium text-gray-600 hover:text-gray-400 focus:outline-none focus:text-gray-400 dark:text-neutral-400 dark:hover:text-neutral-500 dark:focus:text-neutral-500 text-base`}
                        >
                            Anasayfa
                        </Link>
                        <Link href="/hakkimda"
