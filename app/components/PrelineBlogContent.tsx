            ...
            <div className="container mx-auto px-4 md:px-8">
                ...
                <div className="mb-10 md:mb-16">
                    ...
                    <p className="mx-auto max-w-screen-md text-center text-gray-500 md:text-lg">
                        Makaleler bölümümüzde, çeşitli hukuk alanlarında bilgilendirici ve rehber niteliğinde yazılar bulabilirsiniz. Hukuki süreçler, yasal haklar ve davalarla ilgili önemli ipuçları sunan makalelerimiz, size doğru bilgiye ulaşmada yardımcı olacaktır.
                    </p>
                </div>
                {/* text - end */}
