...
function PrelineFeaturesWithVerticalTabs() {
    return (
            ...
            <div className="relative p-6 md:p-16">
              ...
              <span className="flex gap-x-6">
                  ...
                  <span className="block mt-1 text-gray-800 dark:hs-tab-active:text-gray-200 dark:text-neutral-200">
                    ...
                    <div className="lg:col-span-6">
                        <div className="relative">
                            ...
                            {/* SVG Element */}
                            <div
                                className="hidden absolute top-0 end-0 translate-x-20 md:block lg:translate-x-20">
                                <svg
                ...
                <div className="absolute inset-0 grid grid-cols-12 size-full">
                    <div
                        className="col-span-full lg:col-span-7 lg:col-start-6 bg-gray-100 w-full h-5/6 rounded-xl sm:h-3/4 lg:h-full dark:bg-neutral-800"/>
                </div>
...
export default PrelineFeaturesWithVerticalTabs;